...
export default async function handler(req, res) {
    ...
    1. Identificação do Banco Emissor (PRIORIDADE ABSOLUTA):
    ...
    2. Extração e Verificação do Valor do Boleto (CRUCIAL):
    ...
    3. Consistência Geral (Apenas se as Etapas 1 e 2 forem aprovadas):
    ...
    4. Informações Adicionais (Apenas se a Etapa 1 for aprovada):
       
        * Examine o campo "Local de Pagamento" ou instruções similares.
        * ALERTA DE FRAUDE: Se o campo "Local de Pagamento" indicar um banco diferente do banco emissor (identificado na Etapa 1), ALERTE IMEDIATAMENTE sobre a forte suspeita de fraude.
        
    5. Dados do Beneficiário (Apenas se as Etapas 1, 3 e 4 forem aprovadas):
    ...
    6. Análise da Imagem (Apenas se as Etapas 1, 3, 4 e 5 forem aprovadas):
